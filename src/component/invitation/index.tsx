  ...
  return (
    <>
      <LazyDiv className="card invitation">
        ...
        {/* 초대 문구 */}
        <div className="content">겨울의 한 가운데에서</div>
        <div className="content">소중한 여러분들을 온기 담아 모시고</div>
        <div className="content">사랑의 약속을 하려고 합니다.</div>
        <div className="break" />
        <div className="content">삭풍에 맞서 서로를 따스히 감싸안아주는</div>
        <div className="content">그런 부부가 되겠습니다.</div>
        <div className="break" />
